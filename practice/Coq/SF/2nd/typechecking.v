...
Lemma value_nostep: forall t,
    value t -> not (exists t', t --> t').
Proof with eauto.
  intros. induction H; intro HH; inversion HH; try solve_by_invert;
            try (inversion H0; subst; induction IHvalue)...
  inversion H1; subst. induction IHvalue1... induction IHvalue2...
  inversion H1; subst. induction IHvalue1... induction IHvalue2...
Qed.

Theorem step_one : forall t t' t'',
    t --> t' -> t --> t'' -> t' = t''.
Proof with eauto.
  intros. generalize dependent t''. induction H; intros; try solve_by_invert.
  -
    inversion H0; subst... inversion H4.
    apply value_nostep in H. induction H...
  -
    inversion H0; subst. inversion H.
    apply IHstep in H4; subst...
    induction (value_nostep t1)...
  -
    inversion H1; subst. induction (value_nostep t2)...
    induction (value_nostep v1)...
  ...
  -
    inversion H0; subst... inversion H1.
  -
    inversion H0; subst... apply IHstep in H4; subst...
    induction (value_nostep t1)...
    inversion H.
  -
    inversion H1; subst. induction (value_nostep v1)...
    apply IHstep in H6; subst...
    inversion H0.
  -
  ...
  -
    inversion H0; subst... apply IHstep in H4; subst...
  -
    inversion H0; subst... apply IHstep in H7; subst...
    inversion H; subst. induction (value_nostep v0)...
    inversion H; subst. induction (value_nostep v0)...
  -
    inversion H0; subst... inversion H7; subst.
    induction (value_nostep v0)...
  -
    inversion H0; subst... inversion H7; subst.
    induction (value_nostep v0)...
  -
  ...
  -
    ...
    induction (value_nostep v1)...
    induction (value_nostep vl)...
  -
    inversion H0; subst... inversion H6; subst.
  -
    inversion H1; subst... inversion H8; subst.
    induction (value_nostep v1)... induction (value_nostep vl)...
  -
    inversion H0; subst... apply IHstep in H4; subst...
    induction (value_nostep t1)...
  -
    inversion H1; subst... induction (value_nostep t1)...
    apply IHstep in H6; subst...
  -
    inversion H0; subst... apply IHstep in H2; subst...
    induction (value_nostep (pair t'' v2))...
  -
    inversion H0; subst... 
    induction (value_nostep (pair v1 v2))...
  -
    inversion H0; subst... apply IHstep in H2; subst...
    induction (value_nostep (pair v1 t''))...
  -
    inversion H0; subst... 
    induction (value_nostep (pair v1 v2))...
  -
    ...
    induction (value_nostep t1)...
  -
    inversion H0; subst... induction (value_nostep v1)...
  -
    inversion H0; subst... apply IHstep in H2; subst...
    inversion H; subst...
  -
