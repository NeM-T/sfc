...
subst x s t =
  case t of {
   ...
   Abs y t0 t1 -> Abs y t0 (case eqb_string x y of {
                             True -> t1;
                             False -> subst x s t1});
   Const n -> Const n;
   ...
   Tcase t0 y1 t1 y2 t2 -> Tcase (subst x s t0) y1 (case eqb_string x y1 of {
                                                     True -> t1;
   ...
   Test0 t1 t2 t3 ->
    case t1 of {
     ...
     _ -> case stepf t1 of {
           ...
           None -> None}};
   Tinl t0 t1 -> case stepf t1 of {
                  Some t1' -> Some (Tinl t0 t1');
                  None -> None};
   Tinr t0 t1 -> case stepf t1 of {
