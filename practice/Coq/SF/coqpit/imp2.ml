...
let bool_dec b1 b2 =
  if b1
  then if b2 then Left else Right
  else if b2 then Right else Left
...
let ascii_dec a b =
  ...
  let Ascii (b8, b9, b10, b11, b12, b13, b14, b15) = b
  in
...
(** val t_update :
    'a1 total_map -> string -> 'a1 -> string -> 'a1 **)
...
| BAnd (b1, b2) ->
  if beval st b1 then beval st b2 else false
